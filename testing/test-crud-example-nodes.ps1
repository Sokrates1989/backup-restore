...
Write-Host "[OK] Created node with ID: $node1Id" -ForegroundColor Green
Write-Host ""
...
Write-Host "[OK] Created node with ID: $node2Id" -ForegroundColor Green
Write-Host ""
...
Write-Host "[OK] Found $($nodeList.data.total) node(s)" -ForegroundColor Green
...
Write-Host "[OK] Retrieved: $($specificNode.data.name)" -ForegroundColor Green
Write-Host ""
...
Write-Host "[OK] Updated: $($updated.data.name)" -ForegroundColor Green
...
Write-Host "[OK] Found $($filtered.data.total) node(s) matching 'Updated'" -ForegroundColor Green
Write-Host ""
...
Write-Host "[OK] Remaining nodes: $($remaining.data.total)" -ForegroundColor Green
Write-Host ""
...
Write-Host "[OK] $($cleanup.message)" -ForegroundColor Green
Write-Host ""

Write-Host "========================================" -ForegroundColor Cyan
Write-Host "All tests completed successfully! [OK]" -ForegroundColor Green
Write-Host "========================================" -ForegroundColor Cyan
